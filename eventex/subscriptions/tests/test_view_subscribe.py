...
class SubscribePostTest(TestCase):
    ...
    def test_send_subscribe_email(self):
        ''' Must send a email informing sucess subscribe'''
    ...
    def teste_subscription_email_body(self):
        ...
        self.assertIn('Testando Silva', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('teste@gmail.com', email.body)
        self.assertIn('0123', email.body)
